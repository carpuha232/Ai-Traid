...
# Импорты модулей
try:
    from utils.ui_components import UIColors
    from modules.price_manager import PriceManager
    from modules.terminal_manager import AITradingSystem, TradingOpportunityFinder
    from modules.online_data_manager import get_data_manager, initialize_data_manager
...
try:
    from modules.ai_integration import AIInterface, AIRightPanel
except ImportError:
...
try:
    ...
    from modules.ai_analysis_engine import AIAnalysisEngine
