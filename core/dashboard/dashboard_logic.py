...
from modules.aggressive_trade_system import AggressiveTradeSystem
import modules.online_data_manager as online_data_manager
import modules.terminal_manager as terminal_manager
import modules.price_manager as price_manager
import modules.ai_analysis_engine as ai_analysis_engine
import modules.multi_timeframe_analyzer as multi_timeframe_analyzer
import modules.ai_integration as ai_integration
import modules.data_loader as data_loader

# Добавляем импорт эволюционного агента
from modules.evolutionary_rmm_agent import EvolutionaryRMMAgent
# Добавляем импорт анализатора знаний
from modules.knowledge_analyzer import KnowledgeAnalyzer
# Добавляем импорт синхронизации с GitHub
from modules.github_sync import KnowledgeSyncManager
